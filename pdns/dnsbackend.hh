...
public:
  ...
  virtual void lookup(const QType& qtype, const DNSName& qdomain, int zoneId, DNSPacket* pkt_p = nullptr) = 0;
  virtual void APILookup(const QType& qtype, const DNSName& qdomain, int zoneId, bool include_disabled = false);
