...
.. code-block:: cpp
        ...
        virtual void lookup(const QType &qtype, const string &qdomain, int zoneId, DNSPacket *pkt_p=nullptr)=0;
...
.. cpp:function:: void DNSBackend::lookup(const QType &qtype, const string &qdomain, int zoneId, DNSPacket *pkt=nullptr)
